# Contributing to Riniya

We would love for you to contribute to Riniya Project and help make it ever better together! :rocket:
...
Help us keep Riniya open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `Riniya`.
...
* If you have a question about using Riniya, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `Riniya:master`.
...
we use the git commit messages to **generate the Riniya change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/NebraskyTheWolf/Riniya
[stackoverflow]: https://discord.gg/
[issues]: https://github.com/NebraskyTheWolf/Riniya/issues
[new_issue]: https://github.com/NebraskyTheWolf/Riniya/issues/new
[pulls]: https://github.com/NebraskyTheWolf/Riniya/pulls
